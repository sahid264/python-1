...
if choice1 == 'left':
  ...
  if choice2 == 'wait':
    choice3 = input("you have arrived at the island unharmed. There are 3 doors. one red, one  yellow, one blue. which colour do you choose.\n").lower()
    ...
    if choice3 == "red":
      ...
      print("you enter into a room full of beast.Game over.")
    else:
